...
describe Parameters::InstanceParam do
  ...
  describe "type coercion" do
    ...
    it "should coerce values into Hashes" do
      param = described_class.new(@obj,:x,Hash)
    ...
    it "should coerce keys and values within Hashes" do
      param = described_class.new(@obj,:x,Hash[Symbol => Object])
    ...
    it "should coerce values into Sets" do
      param = described_class.new(@obj,:x,Set)
    ...
    it "should coerce values into Sets with types" do
      param = described_class.new(@obj,:x,Set[Integer])
    ...
    it "should coerce values into Arrays" do
      param = described_class.new(@obj,:x,Array)
    ...
    it "should coerce values into Arrays with types" do
      param = described_class.new(@obj,:x,Array[Integer])
    ...
    it "should coerce values into URIs" do
      param = described_class.new(@obj,:x,URI)
    ...
    it "should coerce values into Regexp" do
      param = described_class.new(@obj,:x,Regexp)
    ...
    it "should coerce values into Times" do
      param = described_class.new(@obj,:x,Time)
    ...
    it "should coerce values into Dates" do
      param = described_class.new(@obj,:x,Date)
    ...
    it "should coerce values into DateTimes" do
      param = described_class.new(@obj,:x,DateTime)
    ...
    it "should coerce values into Symbols" do
      param = described_class.new(@obj,:x,Symbol)
    ...
    it "should coerce values into Strings" do
      param = described_class.new(@obj,:x,String)
    ...
    it "should coerce values into Floats" do
      param = described_class.new(@obj,:x,Float)
    ...
    it "should coerce values into Integers" do
      param = described_class.new(@obj,:x,Integer)
    ...
    it "should coerce true boolean values" do
      param = described_class.new(@obj,:x,true)
    ...
    it "should coerce values using a Proc for the type" do
      ...
      param = described_class.new(@obj,:x,coercion_logic)
    ...
    it "should coerce values using custom Classes" do
      ...
      param = described_class.new(@obj,:x,CustomType)
